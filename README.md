...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ig4vrsy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ig4vrsy.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container-ig4vrsy.git
cd container-ig4vrsy
```
...
```
docker attach container-ig4vrsy
```
